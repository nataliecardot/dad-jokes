...
// Hitting 'Enter' with <input type="text"> focused triggers click event on the first positioned element (here, the search button). If onClick were changed to onSubmit, it causes the default submit behavior of submitting a GET request and refreshing the page (search results aren't displayed after refresh). onClick doesn't cause refresh and search results are retrieved correctly
